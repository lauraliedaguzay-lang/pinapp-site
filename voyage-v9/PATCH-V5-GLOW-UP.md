...
- 4 vidéos Vimeo intactes (Walker · SW Teaser · Resident Evil · SW 3 min).  
- 4 encarts placeholder intacts (Pinapp 60s · Lauralie chante · séminaire / anniversaire / captation selon spec V5).  
- Structure 14 scènes (s01–s13 + interstitiels) intacte.  
- Photos hero R1 byte-identiques.  
- Tarifs intacts (39 / 67 / 147 / 397 · 490 / 690 / 890 / 1 290 · 1 890 / 4 900 € · Micha « à partir de »).  
- Doctrine prix Lauralie fixe / Micha sur devis.  
- Easter egg STAY → M&P.  
...
## 30 glow ups — scène par scène

### s01 Hero

| Levier | Avant (ex.) | Après | Pourquoi |
|--------|-------------|--------|----------|
| H1 | « Vos outils travaillent… » | **Option A** : « Vendez plus. Sans bosser le dimanche soir. » · **Option B** : « Récupérez 8 à 14 heures par semaine. Sans embaucher. » | Outcome + douleur |
| CTA primaire | « Diagnostic 24h offert → » | **« Recevoir mon diagnostic gratuit → »** | Possessif + bénéfice (test A/B prioritaire) |
| Social proof | — | *« Déjà X TPE accompagnées en Nouvelle-Aquitaine. »* **uniquement si chiffre vérifiable** | Sinon ne pas afficher (éviter fake stats) |

### s02 Le duo

| Avant | Après |
|--------|--------|
| « Deux cerveaux. Une facture. » | **« Deux experts. Un seul interlocuteur. Un seul devis. »** |

### s03 Le constat

| Avant | Après |
|--------|--------|
| « Ce que vivent vos concurrents en silence. » | **« Reconnaissez-vous votre semaine ? »** |
| Douleur 04 | « Charge mentale H24. » | **« Vous y pensez encore à 23h. »** |

### s04 Pourquoi l’IA

| Avant | Après |
|--------|--------|
| « -50 à -75 % sur tout. Sources publiques. » | **« Pourquoi 50 à 75 % moins cher ? Voici les 4 sources qu’on assume. »** |
...
### s05 Pack Duo (CRO pricing)

- **Essentiel** : afficher ancrage **~~1 970 €~~ → 1 890 € HT** *(80 € économisés)* — prix barré visible.  
- **Signature** : badge **« Le plus demandé »** (neutre si pas de preuve chiffrée).  
- **CTA par carte** : Essentiel → **« Comparer les 2 packs → »** · Signature → **« Réserver mon Pack Signature → »** (pas un seul CTA global ambigu).

### s06 Lauralie vue

| Avant | Après |
|--------|--------|
| « 14 démos sectorielles… » | **« 14 démos. Votre secteur est dedans. Prix affichés. »** |
| Dépliant | « Voir les 11 autres… » | **« Trouver mon secteur (11 démos de plus) → »** |

### s06b Le système

| Avant | Après |
|--------|--------|
| « Un site Lauralie. 8 dimensions invisibles. » | **« Pourquoi un site Lauralie tient dans le temps ? »** + sous-texte : *« 8 choses qu’on gère pour vous. Vous ne les verrez jamais. »* |

### s07 Micha cinéma (overlays)

- Ligne 1 : **bénéfice émotionnel** (ex. *« Walker · 7 jours pour un film qu’on regarde 3 fois »*) ; specs en sous-ligne.

### s08 Climax clip IA

| Avant | Après |
|--------|--------|
| « Un clip CGI cinéma. Voix incluse. Tout en IA. » | **« Un clip Marvel-style. À 1 500 € au lieu de 50 000. »** (contraste) |
| CTA | « Briefer mon clip CGI → » | **« Recevoir un devis clip sous 48h → »** |

### s09 Événementiel

| Avant | Après |
|--------|--------|
| « Hors ligne. Micha se déplace. » | **« Votre événement mérite plus qu’un iPhone. »** + sub : *« Micha filme en Nouvelle-Aquitaine. Déplacement inclus. »* |

### s11 Formations

- Sous pricing : *« 8 sur 10 commencent par Découverte (67 €). »* **si stat vérifiable**, sinon retirer.  
- Cross-sell : remplacer ton marketing-y par **« Une fois Praticien terminé, beaucoup passent au Pack Duo. C’est l’enchaînement logique. »**

### s12 Méthode + tarifs

- Colonne **Avant l’IA** : style « alerte » discret (rouge doux token, pas criard).  
- Pied de tableau : *« Tarifs visibles. Prêts à signer. Devis sous 48h. »*  
- Capacité : **« On prend 3 projets par mois. Pas plus. Pour rester bons. »** + compteur live *« Ce mois : X créneaux dispo »* (règle métier honnête).

### s13 Form

- **3 chemins** : préférer **3 cartes** cliquables (🔧 Site & outils · 🎬 Film & clip · ✨ Pack complet) plutôt que radios seuls (+35–50 % completion typique — à mesurer).  
- Téléphone : **« Téléphone — si vous préférez qu’on rappelle »** (optionnel contextualisé).  
- Submit : **« Envoyer mon brief — réponse écrite sous 24h »**.  
- Réassurance : **« Aucun appel surprise. Aucun engagement. 100 % par écrit. Réponse d’humain — pas de robot. »**

### Modale STAY (popup CRO)

- Fermer **haut droite** visible.  
- **Échap** ferme.  
- **Clic extérieur** ferme.  
- **CTA secondaire** « M’en parler plus tard » (ferme).  
- **Délai** d’apparition ~200 ms (CSS) si ouverture animée.  
- Microcopy : *« Pas un service Pinapp. Un projet parallèle qu’on porte aussi. »*
...
<meta name="description" content="Duo Pinapp : sites qui convertissent + films cinéma. Diagnostic gratuit 24h. Bordeaux + Nouvelle-Aquitaine. Tarifs publics dès 1 290 €.">
<meta property="og:title" content="Pinapp — Sites + Films pour TPE/PME ambitieuses">
<meta property="og:description" content="50 à 75 % moins cher qu'une agence. Tarifs affichés. Diagnostic 24h gratuit.">
<meta property="og:image" content="https://pinapp.fr/voyage-v9/assets/og-card.jpg">
...
<script type="application/ld+json">
{
  ...
  "areaServed": ["FR", "Nouvelle-Aquitaine"],
  "priceRange": "€€",
  "image": "https://pinapp.fr/voyage-v9/assets/hero-1.webp",
  "offers": {
    "@type": "AggregateOffer",
    "lowPrice": "39",
    "highPrice": "4900",
...
Coupler avec les 5 questions **en HTML** (`<details>` / section FAQ). Remplir `mainEntity` avec les mêmes Q&R.

---

## 5 FAQ TPE/PME (à intégrer en s12, s12b ou bloc dédié)

1. **« Et si je n’y connais rien en informatique ? »** → Vous validez par mail. On gère le reste. Pas de logiciel à apprendre.  
2. **« Combien de temps avant d’avoir des résultats ? »** → Site livré sous 3 semaines. Premiers effets leads selon secteur (formulation prudente, pas de promesse magique).  
3. **« Pourquoi vous êtes moins chers qu’une agence ? »** → On est deux, pas quinze. On automatise notre propre travail. On ne sous-traite pas.  
4. **« Que se passe-t-il après les 30 jours d’accompagnement ? »** → Vous gardez code, accès, données. Option Pinapp Care (190–390 €/mois).  
5. **« Vous travaillez avec mon secteur ? »** → 14 démos sectorielles ; si le vôtre manque, cadrage avant devis (process à documenter honnêtement).

---

## Plan A/B (3 tests prioritaires)

1. **Hero H1** : contrôle vs « Vendez plus… » vs « Récupérez 8–14 h… » — métrique : scroll past s01 + clic CTA.  
2. **CTA hero** : « Diagnostic 24h offert » vs « Recevoir mon diagnostic gratuit » — métrique : CTR vers formulaire.  
3. **Form chemins** : radios vs **cards** — métrique : taux de complétion.

---

## Top 5 impact / effort (glow up seul)

1. CTA hero possessif.  
2. Prix barré Pack Essentiel.  
3. Form en cards.  
4. H1 + sous-titre climax contraste 50 000 € / 1 500 €.  
5. Compteur capacité mensuelle honnête.

---

## Ordre d’implémentation recommandé (3 commits — glow up uniquement)

1. **Copy** : headlines, CTA, overlays s07, s08, s09, s11, s12 pieds, s13 microcopy.  
2. **Pricing + form** : barrés, badges, cards chemins, compteur capacité, CTA packs.  
3. **SEO + FAQ + STAY** : meta/OG/Twitter, JSON-LD, 5 FAQ, modale (ESC, overlay, second CTA).

---

## Commit 10 — Taste-design (polish anti-générique)

À enchaîner après les 3 commits glow up (ou intégré au même lot si préféré) :

- Pas de `#000000` pur ; tokens fond existants.  
- Pas de néon / glow violet hors charte.  
...
## Prompt Cursor — glow up seul (3 commits)

```
Lis voyage-v9/PATCH-V5-GLOW-UP.md attentivement.

Sur la branche cursor/voyage-v9-refonte-v5-0309 (ou depuis main si la refonte V5 n’est pas encore mergée), applique les 3 commits séquentiels décrits dans la section « Ordre d’implémentation recommandé ».

CONTRAINTES : section « Contraintes préservées » du PATCH-V5-GLOW-UP.md (intégralité).

Message de commit suggéré : feat(voyage-v9): V5 glow up — CRO + SEO + form + FAQ
```
...
## PowerShell — versionner ce patch sur `main`
...
git checkout main
git pull origin main
git add voyage-v9/PATCH-V5-GLOW-UP.md voyage-v9/PATCH-V5-FINAL.md
git commit -m "docs(voyage-v9): PATCH-V5-GLOW-UP — 30 améliorations CRO + SEO (addendum)"
git push origin main
```

*(Si `PATCH-V5-FINAL.md` est déjà à jour avec le lien addendum, `git add` peut ne contenir que `PATCH-V5-GLOW-UP.md`.)*

---

## Bonus — skills perso Claude (hors dépôt)

Installation locale des repos **marketingskills** / **stitch-skills** : chemins machine Lauralie dans ton message ; à exécuter sur **ton** poste Windows, pas versionné ici.

---

## Option future — Remotion

Génération vidéo « placeholders » par code : hors scope de ce patch ; noter en R&D quand les assets Vimeo / hero sont prêts.

---

*Glow up V5 · addendum 2026-04-26 · 30 améliorations CRO + SEO + garde-fous taste-design · 0 changement offres / vidéos / encarts.*
