...
PowerShell **Windows natif** (pas bash, pas WSL). Trouve les MP4 voyage (**01–08**), les copie dans `assets/video/voyage/`, puis **`git add` uniquement** `assets/video/voyage/*.mp4`, commit et push sur `cursor/v24-step5-transitions-lightbox-df83`, attend le redeploy Netlify (HEAD, max **5 min**), ouvre la preview.
