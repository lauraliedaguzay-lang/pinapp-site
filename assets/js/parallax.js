/* PINAPP — parallax.js
   Conformité pinapp-zero-scroll.mdc :
   - Aucune parallaxe / animation liée au scroll. */
...
document.querySelectorAll('a[href]').forEach(link => {
  ...
  link.addEventListener('click', () => {
    ...
    if (!canvas) return;
    const clair = document.body.classList.contains('mode-clair') || document.body.classList.contains('mode-jour');
