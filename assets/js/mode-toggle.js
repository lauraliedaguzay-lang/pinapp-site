...
const ModeToggle = {
  init() {
    // main.js gère déjà le thème (clair/sombre) + labels (mode clair/sombre).
    // Ce module "mode nuit/jour" est conservé pour compat rétro,
    // mais ne doit pas s'exécuter en doublon.
