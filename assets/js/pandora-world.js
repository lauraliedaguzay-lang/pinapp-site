...
const PandoraWorld = {
  ...
  get SPORES_NUIT() {
    return this.isMobile ? 5 : 14;
  },
  get SPORES_JOUR() {
    return this.isMobile ? 4 : 12;
  },
  get ETOILES() {
    return this.isMobile ? 18 : 72;
  },
  ...
  createSpores() {
    ...
    for (let i = 0; i < count; i++) {
      ...
      spore.style.cssText = [
        ...
        `top:${this.isJour ? Math.random() * 100 : 30 + Math.random() * 70}%`,
  ...
  createStars() {
    ...
    for (let i = 0; i < this.ETOILES; i++) {
      ...
      const opMax = opMin + 0.15 + Math.random() * 0.2;
