...
(function () {
  ...
  function init() {
    ...
    bar.innerHTML =
      '<p style="margin:0;flex:1;min-width:200px;line-height:1.5;">Ce site utilise des cookies strictement nécessaires. Aucun tracking publicitaire. <a href="/confidentialite/" style="color:#00E5B0;text-decoration:none;">En savoir plus</a></p>' +
