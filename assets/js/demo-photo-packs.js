...
(function (g) {
  ...
  g.PINAPP_DEMO_PHOTO_PACKS = {
    ...
    dentiste: {
      photoHero: img('1588776814546-1ffcf47267a5'),
      galerieTitle: 'Cabinet & soins',
      galerie: [
        { src: img('1588776814546-1ffcf47267a5', qM), alt: 'Cabinet', caption: 'Accueil' },
        { src: img('1588776814492-5710b1c0a8c9', qM), alt: 'Salle de soin', caption: 'Équipement' },
        { src: img('1588776814351-6a4b4df6d2c9', qM), alt: 'Soin', caption: 'Précision' },
        { src: img('1588776814784-0b6a68c7b5f1', qM), alt: 'Radiographie', caption: 'Diagnostic' },
        { src: img('1600172454288-934feca24ccd', qM), alt: 'Hygiène', caption: 'Stérilisation' },
        { src: img('1588776814396-7b93c5c79c82', qM), alt: 'Équipe', caption: 'Suivi' },
      ],
      serviceImages: [
        img('1588776814351-6a4b4df6d2c9', qS),
        img('1588776814784-0b6a68c7b5f1', qS),
        img('1600172454288-934feca24ccd', qS),
      ],
      apropos: {
        titre: 'Un parcours clair, sans stress',
        texte:
          'Téléconsultation si besoin, explications simples, suivi post-soin. Le site prépare les infos utiles avant le rendez-vous.',
        photo: img('1588776814492-5710b1c0a8c9', qM),
      },
      servicesTitle: 'Soins proposés',
      servicesSubtitle:
        'Triage, prise de RDV, infos et réassurance — parcours conçu pour un cabinet réel, pas une page “santé” générique.',
      bookingSub: 'En trois questions, on prépare votre rendez-vous (démo).',
      confirmSub: 'Exemple : confirmation email/SMS selon votre outil.',
      preuvePhoto: img('1588776814784-0b6a68c7b5f1', qS),
    },

    immobilier: {
      photoHero: img('1560518883-18d8e3f04b66'),
      galerieTitle: 'Biens & visites',
      galerie: [
        { src: img('1560518883-18d8e3f04b66', qM), alt: 'Façade', caption: 'Quartier' },
        { src: img('1502005229762-cf1b2da88c2b', qM), alt: 'Salon', caption: 'Lumière' },
        { src: img('1505692794403-35d3f9d5a566', qM), alt: 'Cuisine', caption: 'Volumes' },
        { src: img('1528909514045-2fa4ac7a08ba', qM), alt: 'Plan', caption: 'Projet' },
        { src: img('1455081882608-3c2bb1f6f4bb', qM), alt: 'Clés', caption: 'Signature' },
        { src: img('1522708323590-d24dbb6b0267', qM), alt: 'Immeuble', caption: 'Investissement' },
      ],
      serviceImages: [
        img('1455081882608-3c2bb1f6f4bb', qS),
        img('1528909514045-2fa4ac7a08ba', qS),
        img('1522708323590-d24dbb6b0267', qS),
      ],
      apropos: {
        titre: 'Le bon bien, au bon rythme',
        texte:
          'Estimation, dossier complet, visites cadrées. Le site évite les appels inutiles et qualifie les demandes.',
        photo: img('1522708323590-d24dbb6b0267', qM),
      },
      servicesTitle: 'Accompagnement',
      servicesSubtitle:
        'Estimation, prise de contact, dossier — un parcours clair pour gagner du temps côté agence comme côté acheteur.',
      bookingSub: 'Estimation rapide + demande de visite (démo).',
      confirmSub: 'Exemple : rappel automatique et envoi des documents.',
      preuvePhoto: img('1502005229762-cf1b2da88c2b', qS),
    },

    comptable: {
      photoHero: img('1554224155-3a58922a22c4'),
      galerieTitle: 'Cabinet & rigueur',
      galerie: [
        { src: img('1554224155-3a58922a22c4', qM), alt: 'Bureau', caption: 'Accueil' },
        { src: img('1554224154-22dec7ec8818', qM), alt: 'Chiffres', caption: 'Pilotage' },
        { src: img('1542744173-8e7e53415bb0', qM), alt: 'Classeur', caption: 'Ordre' },
        { src: img('1523287562758-66c7fc58967f', qM), alt: 'Équipe', caption: 'Conseil' },
        { src: img('1521790797524-b2497295b8a0', qM), alt: 'Signature', caption: 'Confiance' },
        { src: img('1526304640581-d334cdbbf45e', qM), alt: 'Documents', caption: 'Conformité' },
      ],
      serviceImages: [
        img('1554224154-22dec7ec8818', qS),
        img('1526304640581-d334cdbbf45e', qS),
        img('1523287562758-66c7fc58967f', qS),
      ],
      apropos: {
        titre: 'Moins de charge, plus de pilotage',
        texte:
          'Le site prépare les pièces et clarifie les attentes. Vous arrivez au rendez-vous avec un dossier propre.',
        photo: img('1523287562758-66c7fc58967f', qM),
      },
      servicesTitle: 'Missions',
      servicesSubtitle:
        'Pré-qualification, documents, checklist — la vitrine sert le cabinet et évite les échanges dispersés.',
      bookingSub: 'On prépare votre besoin et vos pièces (démo).',
      confirmSub: 'Exemple : lien sécurisé vers votre espace client.',
      preuvePhoto: img('1526304640581-d334cdbbf45e', qS),
    },

    architecte: {
      photoHero: img('1489515217757-5fd1be406fef'),
      galerieTitle: 'Espaces & matière',
      galerie: [
        { src: img('1489515217757-5fd1be406fef', qM), alt: 'Intérieur', caption: 'Volumes' },
        { src: img('1502005097973-0b5a4d2d48a5', qM), alt: 'Béton', caption: 'Texture' },
        { src: img('1520607162513-77705c0f0d4a', qM), alt: 'Plan', caption: 'Intention' },
        { src: img('1501785888041-af3ef285b470', qM), alt: 'Bois', caption: 'Chaleur' },
        { src: img('1522708323590-d24dbb6b0267', qM), alt: 'Façade', caption: 'Ligne' },
        { src: img('1519710164239-da123dc03ef4', qM), alt: 'Détail', caption: 'Finition' },
      ],
      serviceImages: [
        img('1520607162513-77705c0f0d4a', qS),
        img('1519710164239-da123dc03ef4', qS),
        img('1501785888041-af3ef285b470', qS),
      ],
      apropos: {
        titre: 'Une vision, puis un plan',
        texte:
          'Moodboard, métrés, planning. Le site sert la clarté : ce qui est possible, ce qui ne l’est pas, et comment on avance.',
        photo: img('1520607162513-77705c0f0d4a', qM),
      },
      servicesTitle: 'Prestations',
      servicesSubtitle:
        'Le même socle Pinapp, mais une mise en scène adaptée au cabinet : images, rythme, vocabulaire.',
      bookingSub: 'On qualifie le projet en amont (démo).',
      confirmSub: 'Exemple : proposition de créneau et liste de pièces.',
      preuvePhoto: img('1519710164239-da123dc03ef4', qS),
    },

    photographe: {
      photoHero: img('1529626455594-4ff0802cfb7e'),
      galerieTitle: 'Sélections',
      galerie: [
        { src: img('1529626455594-4ff0802cfb7e', qM), alt: 'Portrait', caption: 'Lumière' },
        { src: img('1529626455535-784cb2d6465b', qM), alt: 'Évènement', caption: 'Instant' },
        { src: img('1487412947147-5cebf100ffc2', qM), alt: 'Mariage', caption: 'Détails' },
        { src: img('1500530854321-586ed83d5d26', qM), alt: 'Nature', caption: 'Calme' },
        { src: img('1519225429380-bcc0a7c65f7c', qM), alt: 'Lieu', caption: 'Cadre' },
        { src: img('1513506003901-1e6ad229e2d7', qM), alt: 'Texte', caption: 'Histoire' },
      ],
      serviceImages: [
        img('1529626455594-4ff0802cfb7e', qS),
        img('1529626455535-784cb2d6465b', qS),
        img('1487412947147-5cebf100ffc2', qS),
      ],
      apropos: {
        titre: 'Savoir cadrer, savoir livrer',
        texte:
          'Un site de photographe doit rassurer et convertir : packs clairs, agenda, livraison. Le reste: votre regard.',
        photo: img('1529626455594-4ff0802cfb7e', qM),
      },
      servicesTitle: 'Packs',
      servicesSubtitle:
        'Chaque pack est un produit. Le site fait le tri et prépare la demande (démo).',
      bookingSub: 'Pack, date, lieu — en quelques choix (démo).',
      confirmSub: 'Exemple : message + devis automatique sur votre flux.',
      preuvePhoto: img('1529626455535-784cb2d6465b', qS),
    },

    fleuriste: {
      photoHero: img('1519741497674-61162186352c'),
      galerieTitle: 'Bouquets & atelier',
      galerie: [
        { src: img('1519741497674-61162186352c', qM), alt: 'Bouquet', caption: 'Blanc' },
        { src: img('1513506003901-1e6ad229e2d7', qM), alt: 'Atelier', caption: 'Geste' },
        { src: img('1499205476559-cfbe5462ee7d', qM), alt: 'Main', caption: 'Assemblage' },
        { src: img('1519225429380-bcc0a7c65f7c', qM), alt: 'Lieu', caption: 'Évènement' },
        { src: img('1520768224289-229f26c7686e', qM), alt: 'Texture', caption: 'Matière' },
        { src: img('1490750967868-88aa4486c946', qM), alt: 'Bougie', caption: 'Ambiance' },
      ],
      serviceImages: [
        img('1519741497674-61162186352c', qS),
        img('1499205476559-cfbe5462ee7d', qS),
        img('1513506003901-1e6ad229e2d7', qS),
      ],
      apropos: {
        titre: 'Du vivant, du précis',
        texte:
          'Le site prépare vos commandes: couleurs, budget, retrait. Et garde l’atelier concentré sur l’essentiel.',
        photo: img('1513506003901-1e6ad229e2d7', qM),
      },
      servicesTitle: 'Bouquets & événements',
      servicesSubtitle:
        'Commande, retrait, devis événement — parcours conçu pour un atelier réel (démo).',
      bookingSub: 'Couleurs, budget, date (démo).',
      confirmSub: 'Exemple : confirmation + rappel jour J.',
      preuvePhoto: img('1519741497674-61162186352c', qS),
    },

    garage: {
      photoHero: img('1515879218367-8466d910aaa4'),
      galerieTitle: 'Atelier & sécurité',
      galerie: [
        { src: img('1515879218367-8466d910aaa4', qM), alt: 'Atelier', caption: 'Pont' },
        { src: img('1503376780353-7e6692767b70', qM), alt: 'Mécanique', caption: 'Diagnostic' },
        { src: img('1581092918056-0c4c3acd3789', qM), alt: 'Outils', caption: 'Précision' },
        { src: img('1525609004556-c46c7d6cf023', qM), alt: 'Pneus', caption: 'Sécurité' },
        { src: img('1517673132405-a56a62b18caf', qM), alt: 'Moteur', caption: 'Entretien' },
        { src: img('1502877338535-766e1452684a', qM), alt: 'Accueil', caption: 'Clarté' },
      ],
      serviceImages: [
        img('1503376780353-7e6692767b70', qS),
        img('1517673132405-a56a62b18caf', qS),
        img('1525609004556-c46c7d6cf023', qS),
      ],
      apropos: {
        titre: 'Transparence et suivi',
        texte:
          'Le site prépare la demande: symptômes, kilométrage, créneau. Moins d’aller-retours, plus de réparation.',
        photo: img('1515879218367-8466d910aaa4', qM),
      },
      servicesTitle: 'Entretien & réparation',
      servicesSubtitle:
        'Parcours orienté efficacité: vous arrivez, on sait déjà quoi regarder (démo).',
      bookingSub: 'Modèle, symptôme, créneau (démo).',
      confirmSub: 'Exemple : devis et rappel automatique.',
      preuvePhoto: img('1525609004556-c46c7d6cf023', qS),
    },

    yoga: {
      photoHero: img('1518611012118-696072aa345a'),
      galerieTitle: 'Cours & respiration',
      galerie: [
        { src: img('1518611012118-696072aa345a', qM), alt: 'Cours', caption: 'Flow' },
        { src: img('1516321318421-f621f2f503d4', qM), alt: 'Carnet', caption: 'Intention' },
        { src: img('1493836512294-502baa1986fc', qM), alt: 'Nature', caption: 'Calme' },
        { src: img('1571019613454-1cb2f99b2d8b', qM), alt: 'Posture', caption: 'Technique' },
        { src: img('1522202176988-66273c2fd55f', qM), alt: 'Groupe', caption: 'Collectif' },
        { src: img('1517836357463-d25dfeac3c3e', qM), alt: 'Respiration', caption: 'Récupération' },
      ],
      serviceImages: [
        img('1518611012118-696072aa345a', qS),
        img('1522202176988-66273c2fd55f', qS),
        img('1516321318421-f621f2f503d4', qS),
      ],
      apropos: {
        titre: 'Un planning qui tient',
        texte:
          'Le site sert l’organisation: planning, réservation, rappels. Vous gardez l’énergie pour vos élèves.',
        photo: img('1518611012118-696072aa345a', qM),
      },
      servicesTitle: 'Cours & ateliers',
      servicesSubtitle: 'Cours, créneaux, ateliers — une vitrine qui prépare la décision (démo).',
      bookingSub: 'Choix du cours + créneau (démo).',
      confirmSub: 'Exemple : lien de paiement ou confirmation automatique.',
      preuvePhoto: img('1522202176988-66273c2fd55f', qS),
    },

    psychologue: {
      photoHero: img('1522202176988-66273c2fd55f'),
      galerieTitle: 'Cadre & écoute',
      galerie: [
        { src: img('1522202176988-66273c2fd55f', qM), alt: 'Cabinet', caption: 'Rendez-vous' },
        { src: img('1506126613408-eca07ce68773', qM), alt: 'Notes', caption: 'Suivi' },
        { src: img('1516321318421-f621f2f503d4', qM), alt: 'Carnet', caption: 'Clarté' },
        { src: img('1493836512294-502baa1986fc', qM), alt: 'Nature', caption: 'Respiration' },
        { src: img('1519225429380-bcc0a7c65f7c', qM), alt: 'Lieu', caption: 'Calme' },
        { src: img('1544367567-0f2fcb009e0b', qM), alt: 'Échange', caption: 'Accompagnement' },
      ],
      serviceImages: [
        img('1522202176988-66273c2fd55f', qS),
        img('1506126613408-eca07ce68773', qS),
        img('1544367567-0f2fcb009e0b', qS),
      ],
      apropos: {
        titre: 'Une première demande structurée',
        texte:
          'Ici, le site prépare votre message: motif, urgence, préférence (cabinet / visio). Vous gardez le contrôle.',
        photo: img('1522202176988-66273c2fd55f', qM),
      },
      servicesTitle: 'Consultations',
      servicesSubtitle:
        'Simplicité, confidentialité, clarté — exemple de vitrine pensée pour un praticien.',
      bookingSub: 'Motif, format, créneau (démo).',
      confirmSub: 'Exemple : accusé de réception + proposition de créneau.',
      preuvePhoto: img('1506126613408-eca07ce68773', qS),
    },

    kinesitherapeute: {
      photoHero: img('1517836357463-d25dfeac3c3e'),
      galerieTitle: 'Mouvement & récupération',
      galerie: [
        { src: img('1517836357463-d25dfeac3c3e', qM), alt: 'Récupération', caption: 'Mobilité' },
        { src: img('1568602471126-139295fcc3ee', qM), alt: 'Exercice', caption: 'Renforcement' },
        { src: img('1593079836568-3241c29412c9', qM), alt: 'Étirements', caption: 'Souplesse' },
        { src: img('1571019614242-c3450a2ad572', qM), alt: 'Salle', caption: 'Matériel' },
        { src: img('1518611012118-696072aa345a', qM), alt: 'Accompagnement', caption: 'Suivi' },
        { src: img('1516321318421-f621f2f503d4', qM), alt: 'Programme', caption: 'Plan' },
      ],
      serviceImages: [
        img('1593079836568-3241c29412c9', qS),
        img('1568602471126-139295fcc3ee', qS),
        img('1571019614242-c3450a2ad572', qS),
      ],
      apropos: {
        titre: 'Votre rééducation, cadrée',
        texte:
          'Le site prépare la prise en charge: motif, ordonnance, disponibilité. Moins de friction, plus de soin.',
        photo: img('1571019614242-c3450a2ad572', qM),
      },
      servicesTitle: 'Soins',
      servicesSubtitle:
        'Parcours orienté pratique: on rassemble les infos essentielles dès le début (démo).',
      bookingSub: 'Motif + créneau (démo).',
      confirmSub: 'Exemple : confirmation et rappels automatisés.',
      preuvePhoto: img('1568602471126-139295fcc3ee', qS),
    },

    nutritionniste: {
      photoHero: img('1540497074882-28dc02a8c7e5'),
      galerieTitle: 'Habitudes & équilibre',
      galerie: [
        { src: img('1540497074882-28dc02a8c7e5', qM), alt: 'Assiette', caption: 'Saison' },
        { src: img('1544025162-d76694265947', qM), alt: 'Cuisine', caption: 'Simple' },
        { src: img('1517248135467-4c7edcad34c4', qM), alt: 'Table', caption: 'Rythme' },
        { src: img('1516321318421-f621f2f503d4', qM), alt: 'Plan', caption: 'Programme' },
        { src: img('1506126613408-eca07ce68773', qM), alt: 'Notes', caption: 'Suivi' },
        { src: img('1493836512294-502baa1986fc', qM), alt: 'Marche', caption: 'Durable' },
      ],
      serviceImages: [
        img('1540497074882-28dc02a8c7e5', qS),
        img('1544025162-d76694265947', qS),
        img('1516321318421-f621f2f503d4', qS),
      ],
      apropos: {
        titre: 'Moins de règles. Plus de constance.',
        texte:
          'Le site prépare votre demande: objectif, contraintes, habitudes. La séance démarre déjà avant la séance.',
        photo: img('1540497074882-28dc02a8c7e5', qM),
      },
      servicesTitle: 'Consultations',
      servicesSubtitle:
        'Vitrine pensée pour convertir sans pression: clarté, preuves douces, action simple (démo).',
      bookingSub: 'Objectif, format, créneau (démo).',
      confirmSub: 'Exemple : envoi d’un questionnaire et rappel.',
      preuvePhoto: img('1517248135467-4c7edcad34c4', qS),
    },

    osteopathe: {
      photoHero: img('1593079836568-3241c29412c9'),
      galerieTitle: 'Posture & précision',
      galerie: [
        { src: img('1593079836568-3241c29412c9', qM), alt: 'Manipulation', caption: 'Douceur' },
        { src: img('1518611012118-696072aa345a', qM), alt: 'Accompagnement', caption: 'Écoute' },
        { src: img('1571019614242-c3450a2ad572', qM), alt: 'Cabinet', caption: 'Cadre' },
        { src: img('1568602471126-139295fcc3ee', qM), alt: 'Mobilité', caption: 'Mouvement' },
        { src: img('1506126613408-eca07ce68773', qM), alt: 'Notes', caption: 'Suivi' },
        { src: img('1493836512294-502baa1986fc', qM), alt: 'Marche', caption: 'Récupération' },
      ],
      serviceImages: [
        img('1593079836568-3241c29412c9', qS),
        img('1518611012118-696072aa345a', qS),
      ...
      apropos: {
        titre: 'Rendez-vous sans friction',
        texte: 'Motif, urgence, historique bref: le site prépare l’accueil (démo).',
        photo: img('1571019614242-c3450a2ad572', qM),
      },
      servicesTitle: 'Séances',
      servicesSubtitle: 'Simple, clair, mobile-first — vitrine adaptée au praticien (démo).',
      bookingSub: 'Motif + créneau (démo).',
      confirmSub: 'Exemple : confirmation et rappel.',
      preuvePhoto: img('1593079836568-3241c29412c9', qS),
    },

    podologue: {
      photoHero: img('1583454110551-21f2fa2afe61'),
      galerieTitle: 'Appuis & performance',
      galerie: [
        { src: img('1583454110551-21f2fa2afe61', qM), alt: 'Cabinet', caption: 'Bilan' },
        { src: img('1517836357463-d25dfeac3c3e', qM), alt: 'Course', caption: 'Sport' },
        { src: img('1593079836568-3241c29412c9', qM), alt: 'Analyse', caption: 'Posture' },
        { src: img('1516321318421-f621f2f503d4', qM), alt: 'Plan', caption: 'Semelles' },
        { src: img('1506126613408-eca07ce68773', qM), alt: 'Notes', caption: 'Suivi' },
        { src: img('1493836512294-502baa1986fc', qM), alt: 'Marche', caption: 'Confort' },
      ],
      serviceImages: [
        img('1583454110551-21f2fa2afe61', qS),
        img('1517836357463-d25dfeac3c3e', qS),
        img('1593079836568-3241c29412c9', qS),
      ],
      apropos: {
        titre: 'Le bon appui, au bon moment',
        texte: 'Le site prépare le bilan: motif, sport, douleur, disponibilité (démo).',
        photo: img('1583454110551-21f2fa2afe61', qM),
      },
      servicesTitle: 'Bilans & semelles',
      servicesSubtitle:
        'Parcours conçu pour réduire les allers-retours et cadrer la demande (démo).',
      bookingSub: 'Motif + créneau (démo).',
      confirmSub: 'Exemple : confirmation et rappel.',
      preuvePhoto: img('1517836357463-d25dfeac3c3e', qS),
    },
  };
