...
(function (g) {
  ...
  g.PINAPP_DEMO_PHOTO_PACKS = {
    ...
    avocat: {
      ...
      galerie: [
        { src: pack('avocat', 'gal-1.webp'), alt: 'Bibliothèque', caption: 'Documentation' },
        { src: pack('avocat', 'gal-2.webp'), alt: 'Bureau', caption: 'Entretien' },
        { src: pack('avocat', 'gal-3.webp'), alt: 'Contrat', caption: 'Conseil' },
        { src: pack('avocat', 'gal-4.webp'), alt: 'Justice', caption: 'Engagement' },
        { src: pack('avocat', 'gal-5.webp'), alt: 'Réunion', caption: 'Équipe' },
        { src: pack('avocat', 'gal-6.webp'), alt: 'Immeuble', caption: 'Paris' },
      ],
      serviceImages: [
        pack('avocat', 'gal-1.webp'),
        pack('avocat', 'gal-2.webp'),
        pack('avocat', 'gal-3.webp'),
      ],
      apropos: {
        ...
        photo: pack('avocat', 'hero-desktop.webp'),
      },
      ...
      preuvePhoto: pack('avocat', 'proof.webp'),
    },
    ...
    surmesure: {
      ...
      galerie: [
        { src: pack('sur-mesure', 'gal-1.webp'), alt: 'Lumière naturelle', caption: 'Accueil' },
        { src: pack('sur-mesure', 'gal-2.webp'), alt: 'Fleurs', caption: 'Composition' },
        { src: pack('sur-mesure', 'gal-3.webp'), alt: 'Allée', caption: 'Lieu' },
        { src: pack('sur-mesure', 'gal-4.webp'), alt: 'Textile', caption: 'Matières nobles' },
        { src: pack('sur-mesure', 'gal-5.webp'), alt: 'Bougie', caption: 'Douceur' },
        { src: pack('sur-mesure', 'gal-6.webp'), alt: 'Forêt', caption: 'Sérénité' },
      ],
      serviceImages: [
        pack('sur-mesure', 'gal-1.webp'),
        pack('sur-mesure', 'gal-2.webp'),
        pack('sur-mesure', 'gal-3.webp'),
      ],
      apropos: {
        titre: 'Chaque histoire mérite une présence digne',
        texte:
          'Exemple de site sur-mesure Pinapp : galerie dense, témoignages, formulaire détaillé — le même niveau d’exigence éditorial et visuel que pour un projet « Mémoire & Présence ». Textes, photos et parcours sont adaptés à votre univers ; ici, illustration avec visuels générés.',
        photo: pack('sur-mesure', 'hero-desktop.webp'),
      },
      ...
      preuvePhoto: pack('sur-mesure', 'proof.webp'),
